...
<table class="normal" >
	<tbody>
		...
		<tr class="prop">
			...
			<td valign="top" style="text-align: left;" class="value">
			<ul>
				<g:each var="t" in="${match.team1Players}">
					<li><g:link controller="player" action="show" id="${t.id}">${t.name}</g:link></li>
				</g:each>
			</ul>
			</td>
		...
		<tr class="prop">
			...
			<td valign="top" style="text-align: left;" class="value">
			<ul>
				<g:each var="t" in="${match.team2Players}">
					<li><g:link controller="player" action="show" id="${t.id}">${t.name}</g:link></li>
				</g:each>
			</ul>
			</td>
...
<div class="buttons"><g:form controller="match">
