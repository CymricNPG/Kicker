    ...
    <table class="normal" width="800">
        <tr>
            <td>
                ...
                button shows all matches, starting with the newest match. Quality shows how well balanced a match was
                (1.0 is perfect).
                <h2>New Match</h2>
                If you click on <span class="menuButton"><g:link class="create"
                                                                 action="create">New Match</g:link></span>
                ...
                <g:datePicker name='date'></g:datePicker>
                <br/>
                ...
                than three games.
                The team that wins two games wins the match. "Draw" (1:1, 2:2, ...) is not allowed as a result of a
                game.<br/>
                ...
                This menu button <span class="menuButton"><g:link class="calc"
                                                                  action="recalc">Recalculate Skill</g:link></span>
                appears only if you're in admin mode.<br/>
                If you have deleted or edited a game, you must recalculate the ELO/Skill. This has to be done manually,
                because
                ...
                In the "Match List" you have to select the match and then click on the Button "Edit" in the lower left
                corner.
                <h2>Delete</h2>
