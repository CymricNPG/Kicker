                ...
                <table class="normal">
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="goals" title="Goals per game" style="width: 140px" />
                            <g:sortableColumn property="diffs" title="Goals diff p. g." style="width: 140px" />
                        </tr>
                    </thead>
                    <tbody>
                    <g:each in="${playerList}" status="i" var="player">
                        ...
                        <tr class="${rclass}">
                            ...
                            <td>${String.format("%.1f",goalsRatio[player.id])}</td>
                            <td>${String.format("%.1f",goalsDiff[player.id])}</td>
                        </tr>
                    </g:each>
                    </tbody>
                </table>
