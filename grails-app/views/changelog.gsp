...
<div class="body">
    ...
    <ul>
        ...
        <li>Add skill fields to domain model. All data must be recalculated (Admin...Matches...Recalculate)</li>
        <li>Replaced Login with Admin</li>
        <li>Remove password from users</li>
        <li>Skill now leading column in player list</li>
    </ul>
    <h2>3.6</h2>
    <ul>
        <li>Added JSkill under Player/Extended, based on the Java implementation: https://github.com/nsp/JSkills<br>
            More Information:
            <ul>
    ...
    <ul>
        <li>Changed domain class Game to Match (database has changed, a
            simple update from 1.3 to 1.4,2.0 or higher is not possible!)
        </li>
    ...
    <ul>
        <li>It's now possible to recalculate the "elo" and score. If you
            delete a game, ask the administrator to start recalculation.
        </li>
    </ul>
    ...
    The application is open source and hosted on <A
        ...
        NAME="Graphic2" ALT="SourceForge Logo" ALIGN=MIDDLE BORDER=0></A>.
</div>
</body>
</html>